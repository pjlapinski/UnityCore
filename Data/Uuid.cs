...
public struct Uuid : IFormattable, IComparable, IComparable<Uuid>, IEquatable<Uuid> {
    ...
    [FieldOffset(0), HideInInspector] public Guid Guid;
    ...
    public static Uuid ParseExact(ReadOnlySpan<char> input, ReadOnlySpan<char> format) => Guid.ParseExact(input, format);
