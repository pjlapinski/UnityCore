...
namespace PJL.SaveSystem
{
    public class SavesManager
    {
        ...
        /// </summary>
        /// <param name="saveIndex">The file's index (NOTE: this is not the index of the file
        ...
        public bool LoadSave(int saveIndex)
        {
            ...
            if (success)
                Settings.SerializationProvider.Deserialize(data);

            return success;
        }

        /// <returns>The preambles of all valid files in the saves directory.</returns>
        public IList<SaveFileData> GetAllSaveFilesData() =>
            Settings.FilesHandler.GetAllSaveFilesData();
    }
