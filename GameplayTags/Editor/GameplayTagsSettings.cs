...
public class GameplayTagsSettings : SettingsProvider {
    ...
    public GameplayTagsSettings(string path, SettingsScope scopes, IEnumerable<string> keywords = null) : base(path, scopes, keywords) {}

    private string TargetPath([System.Runtime.CompilerServices.CallerFilePath] string file = null) {
        if (file == null) {
            return "";
        }
    ...
    public override void OnGUI(string searchContext) {
        ...
        if (GUILayout.Button("Apply")) {
            using (var writer = File.CreateText(TargetPath())) {
                ...
                writer.WriteLine("    internal static readonly string[] Names = new string[]{");
