...
{
    [CustomPropertyDrawer(typeof(Deque<>), true)]
    public class DequeDrawer : PropertyDrawer
    {
        ...
        private SerializedProperty GetModifiedElements(SerializedProperty property)
        {
            ...
            var i = 0;
            foreach (var val in obj) valuesField.GetArrayElementAtIndex(i++).boxedValue = val;
            return valuesField;
        }
    }
}
